...
<body>
 ...
 <div class="da-slider" style="background-color:{{$bannerTV->color_background}};">

 		     <!--start: Wrapper-->
				<div class="container" style="width:100%">	
				
				<div align="center" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
					<div class="logo-tv span3">
						<a class="brand" href="#">
							<img src="packages/assets/image/Logo_Protcap_Padrao.png" alt="Logo_Protcap_Padrao" >
						</a>	
					</div> 	
						<div id="myCarousel" class="carousel slide span9" style="width:75.5%">
					        <!-- Indicators -->
					        <!-- Wrapper for Slides -->
					        <div class="carousel-inner">
					        	...
					        	$cont = 0;?>
					            	...
					            	<img class="item <?php if($cont == 0 ){echo "active";} ?>" src="{{$imageTV->image_path}}" width="100%" height="100%">
					            	<?php $cont++; ?>
					            @endforeach
                             ...
                             <div id="divMedia">
                                 @if ($midia->type == "video")
                                     @if ($midia->type_video == "YouTube")
                                         ...
                                         <iframe width="100%" height="{{$layoutNoticia->height_main}}" src="https://www.youtube.com/embed/{{$video[1]}}?rel=0&amp;controls=0&amp;showinfo=0&amp;autoplay=1&amp;loop=1&amp;playlist={{$video[1]}}" frameborder="0" allowfullscreen></iframe>
                                     @else
                                         <video width="100%" height="{{$layoutNoticia->height_main}}" controls="true" autoplay="true" loop="true">
