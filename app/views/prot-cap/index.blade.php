	...
	<script type="text/javascript">
		...
		function getResolucao(){
			...
			if((w == 800) && (h == 600) || (w <= 800) && (h <= 600)){
				...
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 1');
			}else if((w == 1024) && (h == 768) || (w <= 1024) && (h <= 768)){

				width = '100%';
				height = '590px';

				$('.bannerTop').height(125);

				$('.divMedia').height(590);
				$('.imagemMain').height(590);
				$('.videoMain').height(590);
				$('.textoMain').height(590);

				$('.imagemSide').height(125);
				$('.videoSide').height(105);
				$('.textSide').height(105);

				$('.titleSide').height(63);
				$('.titleSide').css('padding-top',0);
				$('.titleSide').css('overflow','hidden');
				$('.titleSideFirst').css('font-size',14);
				$('.titleSideSecond').css('font-size',10);
				$('.titleSideSecond').css('padding-top',0);
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 2');
				...
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 3');
				...
				$('.titleSideSecond').css('font-size',14);
				$('.titleSideSecond').css('padding-top',2);
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 4');
				...
				$('.titleSideSecond').css('font-size',14);
				$('.titleSideSecond').css('padding-top',2);
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 5');
				...
				console.log('width ' + w + ' x ' + 'height ' +h + ' - 6');
			}
