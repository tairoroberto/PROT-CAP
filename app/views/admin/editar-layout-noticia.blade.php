...
function restaurarPadrao(){
    formEditarLayoutNoticia.action = "{{action('NoticiaController@restaurarPadraoLayouNoticia')}}";
    formEditarLayoutNoticia.submit();
}
</script>
...
@section('content')
            ...
            <div class="content">
              <div class="page-title"> 
                <h3>Editar - <span class="semi-bold">Layout da Notícia</span></h3>
              </div>
              <!-- START FORM -->
              <div class="row">
                <div class="col-md-24">
            ...
            <?php $layoutNoticia = LayoutNoticia::find(1); ?>
                  ...
                  <div class="grid simple">                 
                    <div class="grid-body no-border">
                     {{Form::open(array('id'=>'formEditarLayoutNoticia','action' => 'NoticiaController@storeLayout', 'files' => 'true'))}}
                            ...
                            <label>Altura da notícia LATERAL (pixels)</label>
                              <div class="slider primary">
                                <input type="text" name="alturaNoticiaLateral" id="alturaNoticiaLateral"
                                       data-slider-value="[125]" data-slider-step="5" data-slider-max="1000"
                                       data-slider-min="5" value="125" class="slider-element form-control"
                                       data-slider-selection="after">
                              </div>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12" style="width: 102%">
                          ...
                          <img src="packages/assets/image/menu/gradiente1.png" onclick="selecionaCorSubTitleSelecionado(1,'#EEC73E');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente2.png" onclick="selecionaCorSubTitleSelecionado(2,'#F0A513');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente3.png" onclick="selecionaCorSubTitleSelecionado(3,'#FB8B00');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente4.png" onclick="selecionaCorSubTitleSelecionado(4,'#F44800');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente5.png" onclick="selecionaCorSubTitleSelecionado(5,'#FFFF99');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente6.png" onclick="selecionaCorSubTitleSelecionado(6,'#FFFF00');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente7.png" onclick="selecionaCorSubTitleSelecionado(7,'#FDCA01');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente8.png" onclick="selecionaCorSubTitleSelecionado(8,'#986601');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente9.png" onclick="selecionaCorSubTitleSelecionado(9,'#F44800');" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente10.png"  onclick="selecionaCorSubTitleSelecionado(10,'#FD3301')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente11.png"  onclick="selecionaCorSubTitleSelecionado(11,'#D40000')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente12.png"  onclick="selecionaCorSubTitleSelecionado(12,'#FDD99B')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente13.png"  onclick="selecionaCorSubTitleSelecionado(13,'#D9BB7A')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente14.png"  onclick="selecionaCorSubTitleSelecionado(14,'#816647')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente15.png"  onclick="selecionaCorSubTitleSelecionado(15,'#565248')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente16.png"  onclick="selecionaCorSubTitleSelecionado(16,'#AACCEE')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente17.png"  onclick="selecionaCorSubTitleSelecionado(17,'#6699CC')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente18.png"  onclick="selecionaCorSubTitleSelecionado(18,'#336699')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente19.png"  onclick="selecionaCorSubTitleSelecionado(19,'#003366')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente20.png"  onclick="selecionaCorSubTitleSelecionado(20,'#B3DEFD')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente21.png"  onclick="selecionaCorSubTitleSelecionado(21,'#0197FD')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente22.png"  onclick="selecionaCorSubTitleSelecionado(22,'#0169C9')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente23.png"  onclick="selecionaCorSubTitleSelecionado(23,'#013397')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente24.png"  onclick="selecionaCorSubTitleSelecionado(24,'#CCFF99')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente25.png"  onclick="selecionaCorSubTitleSelecionado(25,'#98FC66')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente26.png"  onclick="selecionaCorSubTitleSelecionado(26,'#339900')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente27.png"  onclick="selecionaCorSubTitleSelecionado(27,'#015A01')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente28.png"  onclick="selecionaCorSubTitleSelecionado(28,'#002B3D')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente29.png"  onclick="selecionaCorSubTitleSelecionado(29,'#FF9BFF')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente30.png"  onclick="selecionaCorSubTitleSelecionado(30,'#FF00FF')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente31.png" onclick="selecionaCorSubTitleSelecionado(31,'#6600CC')"  width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente32.png"  onclick="selecionaCorSubTitleSelecionado(32,'#EEEEEE')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente33.png"  onclick="selecionaCorSubTitleSelecionado(33,'#CCCCCF')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente34.png"  onclick="selecionaCorSubTitleSelecionado(34,'#AAAAAA')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente35.png"  onclick="selecionaCorSubTitleSelecionado(35,'#888888')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente36.png"  onclick="selecionaCorSubTitleSelecionado(36,'#666666')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente37.png"  onclick="selecionaCorSubTitleSelecionado(37,'#333333')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente38.png"  onclick="selecionaCorSubTitleSelecionado(38,'#000000')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente39.png"  onclick="selecionaCorSubTitleSelecionado(39,'#00FFFF')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente40.png"  onclick="selecionaCorSubTitleSelecionado(40,'#98FB98')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente41.png"  onclick="selecionaCorSubTitleSelecionado(41,'#7CFC00')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente42.png"  onclick="selecionaCorSubTitleSelecionado(42,'#00FF7F')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente43.png"  onclick="selecionaCorSubTitleSelecionado(43,'#00FA9A')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente44.png"  onclick="selecionaCorSubTitleSelecionado(44,'#9ACD32')" width="17px"height="20px">

                          <img src="packages/assets/image/menu/gradiente46.png"  onclick="selecionaCorSubTitleSelecionado(46,'#FFFFFF')" width="17px" height="20px">

                          <img src="packages/assets/image/menu/gradiente45.png"  onclick="selecionaCorSubTitleSelecionado(45,'#67BD50')" width="17px"height="20px">
