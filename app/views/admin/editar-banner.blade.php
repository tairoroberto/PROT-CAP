...
@section('head')
  ...
  <script type="text/javascript">
      ...
      function deleteImage(id){
          formBanner.action = "{{action('BannerController@destroy')}}";
      ...
      function selecionaPosicao(id_imagem, count){
          ...
          formBanner.action = "{{action('BannerController@selecionarPosicaoBanner')}}";
          formBanner.submit();
      }
</script>
...
@section('content')
            ...
            <div class="content">
              <div class="page-title"> 
                <h3>Editar - <span class="semi-bold">Banner</span></h3>
              </div>
              <!-- START FORM -->
              <div class="row">
                <div class="col-md-24">
                ...
                @endif
                  ...
                  <div class="grid simple">
                    ...
                    <div class="grid-body no-border">
                     {{Form::open(array('id'=>'formBanner','action' => 'BannerController@store', 'files' => 'true'))}}
                         ...
                         <div class="row form-row">
                          ...
                          <div class="grid-body">
                            <table class="table table-hover table-condensed" id="example">
                              ...
                              <tbody> 
                                  ...
                                  <?php $images = ImageBanner::where('id_banner','=',1)->get(); ?>
                                  <?php $countImagens = ImageBanner::all()->count();?>
                                  <?php $count = 0;?>

                                   @foreach ($images as $image)
                                      <tr >
                                       <td onclick="deleteImage({{$image->id}})">
                                         <a href="#">
                                          <i class="fa fa-times"> 
                                          </i>                                      
                                          </a>  
                                        </td>
                                        <td class="v-align-middle">{{$image->old_name}}</td>

                                          <td>
                                              <select name="selectPosicao{{$count}} "id="selectPosicao{{$count}}" class="form-control" onchange="selecionaPosicao('{{$image->id}}', '{{$count}}')">

                                                  @if($image->position != 0)
                                                      <option value="{{$image->position}}">{{$image->position}}</option>
                          ...
                          <div class="col-md-12">
                            <label>Altura do banner (pixels)</label>
                              ...
                              <div class="slider primary">
                                <input type="text" name="larguraBanner" id="larguraBanner"  data-slider-value="[100]" data-slider-step="5" data-slider-max="100" data-slider-min="5" value="100" class="slider-element form-control" data-slider-selection="after">
                              </div>
                ...
                <input type="hidden" id="posicao" name="posicao" value="">
                   ...
                   <div class="row">
                      ...
                      <br><br><br><br><br>                     
                      <div align="center">
                        <img id="imageMenuSelected" name="imageMenuSelected" src="{{$banner->color_background_path}}" width="150px" height="70px">
                      </div>
                    </div>
               </div>
